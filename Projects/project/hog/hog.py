...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_scoring_num = make_averaged(roll_dice, total_samples)(1, dice)
    number = 1
    for i in range(2, 11):
        m = make_averaged(roll_dice, total_samples)(i, dice)
        if m > max_scoring_num:
            max_scoring_num = m
            number = i
    return number
    # END PROBLEM 9
